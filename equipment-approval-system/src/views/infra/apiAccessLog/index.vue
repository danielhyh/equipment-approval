<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column align="center" fix="right" label="日志编号" prop="id" width="100" />
      ...
      <el-table-column align="center" label="应用名" prop="applicationName" width="150" />
      <el-table-column align="center" label="请求方法" prop="requestMethod" width="80" />
      <el-table-column align="center" label="请求地址" prop="requestUrl" width="500" />
      ...
      <el-table-column align="center" label="操作模块" prop="operateModule" width="180" />
      <el-table-column align="center" label="操作名" prop="operateName" width="180" />
