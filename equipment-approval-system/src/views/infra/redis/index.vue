  ...
  <el-scrollbar height="calc(100vh - 88px - 40px - 50px)">
    <el-row>
      ...
      <el-col :span="24" class="card-box" shadow="hover">
        <el-card>
          <el-descriptions :column="6" border title="基本信息">
      ...
      <el-col :span="12" class="mt-3">
        <el-card :gutter="12" shadow="hover">
          <Echart :height="420" :options="commandStatsRefChika" />
        </el-card>
      </el-col>
      <!-- 内存使用量统计 -->
      <el-col :span="12" class="mt-3">
        <el-card :gutter="12" class="ml-3" shadow="hover">
          <Echart :height="420" :options="usedmemoryEchartChika" />
        </el-card>
      </el-col>
    </el-row>
  </el-scrollbar>
