<template>
  <ContentWrap :body-style="{ padding: '0px' }" class="!mb-0">
    ...
    >
      <fc-designer ref="designer" :config="designerConfig" class="my-designer">
        <template #handle>
          <el-button plain size="small" type="primary" @click="showJson">生成JSON</el-button>
          <el-button plain size="small" type="success" @click="showOption">生成Options</el-button>
          <el-button plain size="small" type="danger" @click="showTemplate">生成组件</el-button>
        </template>
      </fc-designer>
    </div>
  </ContentWrap>
