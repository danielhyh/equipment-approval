    ...
    <el-form :model="formData" :rules="rules" label-width="85px">
      <el-card class="property-group" header="风格" shadow="never">
        <el-form-item label="背景图片" prop="bgImgUrl">
          <UploadImg v-model="formData.bgImgUrl" height="40px" width="100%">
        ...
        <el-form-item label="偏移量" label-width="70px" prop="marginLeft">
          <el-slider
        ...
        <el-form-item label="高度" label-width="70px" prop="height">
          <el-slider
