  ...
  <ComponentContainerProperty v-model="formData.style">
    ...
    <el-form :model="formData" class="m-t-8px" label-width="80px">
      <el-form-item label="上传图片" prop="imgUrl">
        <UploadImg v-model="formData.imgUrl" class="min-w-80px" height="50px" width="auto">
          <template #tip>
            <el-text size="small" type="info"> 推荐宽度 750</el-text>
          </template>
        </UploadImg>
      </el-form-item>
    </el-form>

    <el-button class="w-full" plain type="primary" @click="handleOpenEditDialog">
      设置热区
    </el-button>
