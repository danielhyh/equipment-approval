<template>
  ...
  >
    <template #header>
      <div class="config-header">
        ...
        <div v-else class="node-name">
          {{ nodeName }}
          <Icon :size="16" class="ml-1" icon="ep:edit-pen" @click="clickIcon()" />
        </div>
    ...
    <el-tabs v-if="approveType === ApproveType.USER" v-model="activeTabName" type="border-card">
        ...
        <div>
          <el-form ref="formRef" :model="configForm" :rules="formRules" label-position="top">
              ...
              >
                <el-row>
                  <el-col v-for="(dict, index) in CANDIDATE_STRATEGY" :key="index" :span="8">
                    <el-radio :label="dict.value" :value="dict.value">
                      {{ dict.label }}
                    </el-radio>
                  </el-col>
                </el-row>
            ...
            <el-form-item
              ...
              prop="formUser"
            >
              <el-select v-model="configForm.formUser" clearable filterable style="width: 100%">
                <el-option
            ...
            <el-form-item
              ...
              prop="formDept"
            >
              <el-select v-model="configForm.formDept" clearable filterable style="width: 100%">
                <el-option
            ...
            <el-form-item
              ...
              span="24"
            >
              <el-select v-model="configForm.deptLevel" clearable filterable>
                <el-option
                ...
                <el-radio-group v-model="configForm.rejectHandlerType">
                  <div class="flex-col">
                    <div v-for="(item, index) in REJECT_HANDLER_TYPES" :key="index">
                      <el-radio :key="item.value" :label="item.label" :value="item.value" />
                    </div>
                  </div>
                </el-radio-group>
              </el-form-item>
            ...
            <div v-if="currentNode.type === NodeType.USER_TASK_NODE">
              ...
              <el-form-item v-if="configForm.timeoutHandlerEnable" label="超时时间设置">
              ...
              <el-form-item
                ...
                prop="maxRemindCount"
              >
                <el-input-number v-model="configForm.maxRemindCount" :max="10" :min="1" />
              </el-form-item>
            </div>
      ...
      >
        <div class="button-setting-pane">
          ...
          <div v-for="(item, index) in buttonsSetting" :key="index" class="button-setting-item">
