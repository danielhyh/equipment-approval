        ...
        <div>
          <el-form ref="formRef" :model="configForm" :rules="formRules" label-position="top">
            ...
            <el-form-item label="主→子变量传递" prop="inVariables">
              <div v-for="(item, index) in configForm.inVariables" :key="index" class="flex pt-2">
                <div class="mr-2">
                  <el-form-item
                  ...
                  >
                    <el-select v-model="item.source" class="w-200px!">
                      <el-option
                ...
                <div class="mr-2">
                  ...
                  >
                    <el-select v-model="item.target" class="w-200px!">
                      <el-option
              ...
              <el-button text type="primary" @click="addVariable(configForm.inVariables)">
            ...
            <el-form-item
              ...
              prop="outVariables"
            >
              <div v-for="(item, index) in configForm.outVariables" :key="index" class="flex pt-2">
                <div class="mr-2">
                  <el-form-item
              ...
              <el-button text type="primary" @click="addVariable(configForm.outVariables)">
                <Icon class="mr-5px" icon="ep:plus" />添加一行
              </el-button>
            </el-form-item>
            ...
            >
              <el-select v-model="configForm.startUserFormField" class="w-200px!">
                <el-option
                  v-for="(field, fIdx) in formFieldOptions"
                  :key="fIdx"
                  :label="field.title"
            ...
            <div v-if="configForm.multiInstanceEnable">
              ...
              <el-form-item v-if="configForm.multiInstanceSourceType === ChildProcessMultiInstanceSourceTypeEnum.NUMBER_FORM">
                <el-select v-model="configForm.multiInstanceSource" class="w-200px!">
                  <el-option
