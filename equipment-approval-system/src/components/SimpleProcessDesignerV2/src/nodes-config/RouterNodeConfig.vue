  ...
  >
    ...
    <div>
      <el-form label-position="top">
        <el-card v-for="(item, index) in routerGroups" :key="index" class="mb-15px">
          <template #header>
            <div class="flex flex-items-center">
              <el-text size="large">路由{{ index + 1 }}</el-text>
              <el-select v-model="item.nodeId" class="ml-15px" style="width: 180px">
                <el-option
              ...
              <el-button class="mla" link type="danger" @click="deleteRouterGroup(index)">
                删除
              </el-button>
            </div>
          </template>
      ...
      <el-button :icon="Plus" class="w-1/1" type="primary" @click="addRouterGroup">
        新增路由分支
      </el-button>
    </div>
    <template #footer>
