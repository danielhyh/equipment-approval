<template>
    ...
    <div class="position-absolute top-0px right-0px bg-#fff z-index-button-group">
      <el-row justify="end" type="flex">
        <el-button-group key="scale-control" size="default">
          ...
          />
          <el-button :icon="ScaleToOriginal" size="default" @click="processReZoom()" />
          <el-button :icon="ZoomOut" :plain="true" size="default" @click="zoomOut()" />
          <el-button class="w-80px" size="default"> {{ scaleValue }}% </el-button>
          <el-button :icon="ZoomIn" :plain="true" size="default" @click="zoomIn()" />
  ...
  <Dialog v-model="errorDialogVisible" :fullscreen="false" title="保存失败" width="400">
