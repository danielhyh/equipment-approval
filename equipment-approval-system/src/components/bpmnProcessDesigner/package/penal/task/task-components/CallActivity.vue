  ...
  <div>
    <el-form label-width="100px">
      ...
      <div>
        ...
        <el-table :data="inVariableList" border fit max-height="240">
          <el-table-column label="源" min-width="100px" prop="source" show-overflow-tooltip />
          <el-table-column label="目标" min-width="100px" prop="target" show-overflow-tooltip />
          <el-table-column label="操作" width="110px">
            <template #default="scope">
              <el-button link size="small" @click="openVariableForm('in', scope.row, scope.$index)">
                编辑
              </el-button>
      ...
      <div>
        ...
        <el-table :data="outVariableList" border fit max-height="240">
          <el-table-column label="源" min-width="100px" prop="source" show-overflow-tooltip />
          <el-table-column label="目标" min-width="100px" prop="target" show-overflow-tooltip />
          <el-table-column label="操作" width="110px">
            <template #default="scope">
    ...
    <el-dialog
      ...
      width="600px"
    >
      <el-form ref="varialbeFormRef" :model="varialbeFormData" label-width="80px">
